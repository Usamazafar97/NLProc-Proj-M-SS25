...
class EnhancedRAGPipeline:
    ...
    def _compute_recall_f1(self, prediction, ground_truth):
    ...
    def run_test_suite(self, test_file: str = "data/enhanced_test_inputs.json", answer_file: Optional[str] = None, precision_k: int = 5):
        """
        Run enhanced test suite with various query types and Precision@k, Recall, and F1 evaluation
        """
        ...
        for i, test_case in enumerate(test_data):
            ...
            # Precision@k, Recall, and F1 evaluation if reference answer is available
            ref_answer = None
            ...
            if ref_answer:
                ...
                recall, f1 = self._compute_recall_f1(result['answer'], ref_answer)
